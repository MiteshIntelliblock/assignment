...
function Bank() {
  ...
  return (
    <div>
      ...
      <div className="RBOX0">
        src = '/images/BNZ logo.png' alt='bnwnow'
        <img
          className="whitegola1"
          src="/images/white.png"
          alt="whitegola"
        ></img>
        <img
          className="greengola1"
          src="/images/green.png"
          alt="greengolagola"
        ></img>
        <h2 className="q5">
          Fill in the information to know how much{" "}
          <span
            classname="q5a"
            style={{ fontWeight: "bold", color: "#52F40D" }}
          >
            BCO2
          </span>{" "}
          you should{" "}
        ...
        <h2 className="q6">
          By using this{" "}
          <span style={{ fontWeight: "bold", color: "#52F40D" }}>
            calculator
          </span>{" "}
          you agree to our T&C of use.
        </h2>
        <h2 className="q7">
          Register with BNZ now to know your carbon footprint in detail.
        </h2>
      ...
      <div className="RBOX1">
        ...
        {isOpen.box1.isOpen && (
          <div className="boxbox1">
            ...
            <button className="Rbutton3" onClick={decreasecount2}>
              -
            </button>
            <button className="Rbutton4" onClick={increasecount2}>
              +
            </button>
          </div>
        )}
        ...
        {isOpen.box3.isOpen && (
          <div className="boxbox3">
            ...
            <button className="Rbutton7" onClick={decreasecount4}>
              -
            </button>
            <button className="Rbutton8" onClick={increasecount4}>
              +
            </button>
      ...
      <div className="RBOX2">
        ...
        <div className="boxbox4">
          ...
          <button className="Rbutton9" onClick={decreasecount5}>
            -
          </button>
          <button className="Rbutton10" onClick={increasecount5}>
            +
          </button>
        </div>
      ...
      <div className="RBOX4">
        ...
        <button className="Rbutton11" onClick={decreasecount6}>
          -
        </button>
        <button className="Rbutton12" onClick={increasecount6}>
          +
        </button>
        <p className="purchased">Renewable electricity purchased: </p>
        <h1 className="RCOUNT7">{count7} </h1>
        <button className="Rbutton13" onClick={decreasecount7}>
          -
        </button>
        <button className="Rbutton14" onClick={increasecount7}>
          +
        </button>
      </div>
      <div className="RBOX5">
        ...
        <button className="Rbutton15" onClick={decreasecount8}>
          -
        </button>
        <button className="Rbutton16" onClick={increasecount8}>
          +
        </button>
        <p className="dist">Average distance in km: </p>
        <h1 className="RCOUNT9">{count9} </h1>
        <button className="Rbutton17" onClick={decreasecount9}>
          -
        </button>
        <button className="Rbutton18" onClick={increasecount9}>
          +
        </button>
      ...
      <div className="RBOX6">
        ...
        <button className="Rbutton19" onClick={decreasecount10}>
          -
        </button>
        <button className="Rbutton20" onClick={increasecount10}>
          +
        </button>
        <p className="avgdistance2">Average distance for car: </p>
        <input className="avgdist2" type="text" placeholder=" Value" />
        <h3 className="companyveh">Company vehicle</h3>
        <p className="totaltrips">Total no. of trips: </p>
        <input className="totaltrips1" type="text" placeholder=" Value" />
        <hr className="hr10"></hr>
        <p className="contract">Average distance on contract bus: </p>
        <input className="contract1" type="text" placeholder=" Value" />
      </div>
      <div className="RBOX7">
        ...
        <input className="travelkm1" type="text" placeholder=" Value" />
